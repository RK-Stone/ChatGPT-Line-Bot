...
def index():
  with open(os.path.join('template/index.html'), 'r', encoding='utf-8') as index:
...
def stuall():
  with open(os.path.join('template/stuall.html'), 'r', encoding='utf-8') as stuall:
...
def stuone():
  with open(os.path.join('template/stuone.html'), 'r', encoding='utf-8') as stuone:
...
def contact():
  with open(os.path.join('template/contact.html'), 'r', encoding='utf-8') as contact:
